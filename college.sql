...
SELECT grade, COUNT(rollno) FROM student GROUP BY grade ORDER BY rollno ASC;
SELECT mode, COUNT(customer) FROM payment GROUP BY mode;/*Practice question answer*/
